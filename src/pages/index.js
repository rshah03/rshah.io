  ...
  <div className="animated fadeInLeft">
    ...
    <Grid centered doubling stackable columns={2}>
      <Grid.Row className="imageSection">
        ...
        <Grid.Column>
          <p className="aboutMe"><p className="myName">My name is Ronak Shah.</p>I am a senior at the University of Houston, pursuing a degree in Computer Science, with a specification in Software Design and Development.</p>
