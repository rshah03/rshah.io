          ...
          <a href="https://github.com/rshah03/WeatherUp" target="_blank">
            <Card centered>
              <Card.Content>
                ...
                <Card.Description>A React based, simple weather conglomerate application using Redux for state management.</Card.Description>
              </Card.Content>
            </Card>
          </a>
        </Grid.Column>
          ...
          <a href="https://github.com/rshah03/Minesweeper" target="_blank">
              <Card centered>
                <Card.Content>
                  ...
                  <Card.Description>Minesweeper recreated in Java using Swing UI, JUnit for TDD, and packaged with Gradle.</Card.Description>
                </Card.Content>
              </Card>
            </a>
        </Grid.Column>
